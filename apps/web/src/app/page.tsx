  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-[100dvh] bg-black text-white select-none relative overflow-x-hidden">
        ...
        <header className="h-14 px-4 ios-glass-header flex items-center justify-between shrink-0 sticky top-0 z-20">
        ...
        {authLoading ? (
          ...
          <main className="flex-1 flex flex-col p-4 max-w-md mx-auto w-full pb-12 z-10">
